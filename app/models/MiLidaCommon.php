...
class MiLidaCommon extends \Phalcon\Mvc\Model
{
    ...
    public function getStorageOverview($wid)  {
          ...
          $sql ="SELECT *,  (select count(*) from packages p where p.series_id=o.series_id and p.location_id =:wid and p.pallet_id is not null) as scnt from overview_by_location_2 where location_id=:wid and pallet_code is not null";
