...
class MiLidaCommon extends \Phalcon\Mvc\Model
{
    ...
    public function getSentPallets($wid,$shipment="0")
    {
        ...
        $result['shipment_pallets_24h']=$this->db->fetchOne("SELECT count(*)  as val FROM overwiew_shipment", \Phalcon\Db::FETCH_ASSOC, []);
        $result['shipment_packages_24h']=$this->db->fetchOne("SELECT sum(total)  as val FROM overwiew_shipment", \Phalcon\Db::FETCH_ASSOC, []);
        $result['shipment_weight_24h']=$this->db->fetchOne("SELECT sum(total_weight)  as val FROM overwiew_shipment", \Phalcon\Db::FETCH_ASSOC, []);
