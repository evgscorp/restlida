...
order by creation_time desc";
    ...
    public function getShiftProductionInfo($gid)
    {
        ...
        $sql_pallets_uncompleted="SELECT count(*) CNT, pallet_id FROM packages_info p WHERE group_id in (select group_id from groups where =:shift_id) GROUP BY pallet_id HAVING CNT < 16";
