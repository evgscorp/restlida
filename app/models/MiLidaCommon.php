 ...
 public function initialize()
  {
	...
	public function getShiftProductionInfo($gid)
   {
		 ...
		 $sql_first_package="SELECT timestmp FROM packages_info where operation_id = :operation_id and group_id =:group_id  order by timestmp desc limit 1";
		 $this->utf8init();
     ...
     $result['pallets_passed']=$this->db->fetchColumn($sql_pallets,['operation_id'=>2,'group_id'=>$gid],'cnt');
		 $result['first_package']=$this->db->fetchColumn($sql_first_package,['operation_id'=>2,'group_id'=>$gid],'timestmp');
     return $result;
   }
