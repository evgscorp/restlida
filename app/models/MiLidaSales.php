...
class MiLidaSales extends \Phalcon\Mvc\Model
{
    ...
    public function  saveJob($data){
      ...
      //  array(0, $data->customerId, $data->location_id?$data->location_id:null , $data->weight, 10, $data->sdate, $data->priority ));
        return $result['res']=$this->db->fetchAll("CALL create_job($data->customerId, $data->weight,$data->location_id, $data->location_id, $data->product, $data->ip, $data->precise,'$data->sstdate','$data->sedate','$data->sdate', $data->priority);", \Phalcon\Db::FETCH_ASSOC, []);
     }
